...
namespace ResponsibleSystem.EntityFrameworkCore.Seed.Tenants
{
    public class TenantRoleAndUserBuilder
    {
        ...
        private void CreateRolesAndUsers()
        {
            ...
            var adminRole = _context.Roles.IgnoreQueryFilters().FirstOrDefault(r => r.TenantId == _tenantId && r.Name == AppUserRole.Admin.GetDescriptionFromValue());
            if (adminRole == null)
            {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new ResponsibleSystemAuthorizationProvider())
